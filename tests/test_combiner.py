...
class TestCombiner(unittest.TestCase):
    ...
    def test_training(self):
        ...
        self.assertAlmostEqual(2.510066032409668, float(train_outputs[-1]['loss']), places=6)
        ...
        self.assertAlmostEqual(-1489.196533203125, float(tf.reduce_sum(pred_text_mel['mel'])))
        ...
        self.assertAlmostEqual(2.5442395210266113, float(val_outputs[-1]['loss']), places=6)
